...
export function VideoPlayer({ title, placeholder, compact = false, videoSrc }: VideoPlayerProps) {
  ...
  const showPlaceholder = !videoSrc
  ...
  return (
    ...
    >
      {/* Placeholder for video - shown only when no videoSrc */}
      {showPlaceholder && (
      ...
      {/* Video element - shown when videoSrc is provided */}
      {videoSrc && (
        <video
          ref={videoRef}
      ...
      {/* Controls overlay - only shown when video is available */}
      {videoSrc && (
